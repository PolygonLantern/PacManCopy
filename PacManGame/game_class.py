...
class Game:
    def __init__(self):
        ...
        # variable that points to the background sound file, just for ease than having to browse through the code
        self.backgroundMusicPath = "Presets/BackgroundMusic.flac"
        # highscore variable
        self.highScore = 0
    ...
    def run(self):
        ...
        mixer.music.load(self.backgroundMusicPath)
        # make the music loop
        mixer.music.play(-1)
