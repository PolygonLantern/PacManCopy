...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, game, position):
        ...
        # sound effect for the death
        self.deathSound = mixer.Sound("Presets/SoundFX/PlayerDeath.wav")
        # amount collected coins and pickups
        self.collectedLoot = 0
        self.hasCollectedPickUp = False
